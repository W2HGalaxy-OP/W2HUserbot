...
async def _(event):
    ...
    if Config.GOOGLE_CHROME_BIN is None:
        ...
        return
    hell = await edit_or_reply(event, "Processing ...weit")
...
CmdHelp("capture").add_command(
        "screenshot", "<link>", "Gives out the web screenshot of given link via Google Crome Bin in .png format", ".screenshot https://github.com/LEGEND-OS/W2HBOT"
).add_command(
